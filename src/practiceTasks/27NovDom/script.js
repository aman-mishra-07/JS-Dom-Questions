    ...
    const productList = {
        ...
        bind: function () {
            ...
            selectors.productList.addEventListener('click', (e) => {
                if (e.target.hasAttribute('data-addToCartBtn')) {
                    ...
                    if(this.cart.indexOf(item) == -1){
                        ...
                        selectors.productCount.innerHTML = this.cart.length
                    }
            ...
            selectors.search.addEventListener('input', useDebounce(() => {
                ...
                let searchRes = getData(`https://fakestoreapi.com/products/category/${searchKeywords}`)
        ...
        renderCart: function () {
            ...
            document.querySelector('[data-productCount]').innerHTML = this.cart.length
        }
    }
...
//cookies & cookie methos authentication or authentication expired